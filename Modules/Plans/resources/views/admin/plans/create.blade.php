<x-company::layouts.master>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-8">
            <h3 class="text-xl font-bold text-slate-800 mb-6 border-b border-gray-50 pb-4">Define Plan Details & Limits</h3>
            ...
            <form action="{{ route('admin.plans.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="e.g. Enterprise Pro" class="w-full rounded-xl border-gray-200 focus:border-[#4169E1] focus:ring-[#4169E1] transition-all">
                        @error('name')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                    </div>

                    <div class="col-span-2">
                        <label for="description" class="block text-sm font-bold text-gray-700 mb-1">Description</label>
                        <textarea name="description" id="description" rows="2" class="w-full rounded-xl border-gray-200 focus:border-[#4169E1] focus:ring-[#4169E1] transition-all">{{ old('description') }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="price" id="price" value="{{ old('price') }}" required class="w-full rounded-xl border-gray-200 focus:border-[#4169E1] focus:ring-[#4169E1] transition-all">
                    ...
                    <div>
                        ...
                        @error('billing_cycle')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="max_qr_numbers" id="max_qr_numbers" value="{{ old('max_qr_numbers', 1) }}" required class="w-full rounded-xl border-gray-200 focus:border-[#4169E1] focus:ring-[#4169E1] transition-all">
                        @error('max_qr_numbers')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                    </div>

                    <div>
                        <label for="max_agents" class="block text-sm font-bold text-gray-700 mb-1">Max Agents *</label>
                        <input type="number" name="max_agents" id="max_agents" value="{{ old('max_agents', 5) }}" required class="w-full rounded-xl border-gray-200 focus:border-[#4169E1] focus:ring-[#4169E1] transition-all">
                        @error('max_agents')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                    </div>

                    <div>
                        <label for="max_telegram_bots" class="block text-sm font-bold text-gray-700 mb-1">Max Telegram Bots *</label>
                        <input type="number" name="max_telegram_bots" id="max_telegram_bots" value="{{ old('max_telegram_bots', 1) }}" required class="w-full rounded-xl border-gray-200 focus:border-[#4169E1] focus:ring-[#4169E1] transition-all">
                    ...
                    <div>
                        ...
                        <input type="number" name="max_session_messages" id="max_session_messages" value="{{ old('max_session_messages', 1000) }}" required class="w-full rounded-xl border-gray-200 focus:border-[#4169E1] focus:ring-[#4169E1] transition-all">
                        @error('max_session_messages')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                    </div>

                    <div>
                        <label for="max_template_messages" class="block text-sm font-bold text-gray-700 mb-1">Max Template (Outbound) *</label>
                        <input type="number" name="max_template_messages" id="max_template_messages" value="{{ old('max_template_messages', 100) }}" required class="w-full rounded-xl border-gray-200 focus:border-[#4169E1] focus:ring-[#4169E1] transition-all">
                        @error('max_template_messages')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                    </div>

                    <div class="mt-4 flex items-center">
                        <input type="hidden" name="is_active" value="0">
                        <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', 1) ? 'checked' : '' }} class="rounded border-gray-300 text-[#4169E1] focus:ring-[#4169E1] h-5 w-5">
